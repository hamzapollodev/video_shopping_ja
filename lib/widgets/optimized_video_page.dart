...
class OptimizedVideoPage extends StatelessWidget {
  /// Create video page view with optimized preloading.
  const OptimizedVideoPage({
    ...
    this.actionsPadding,
    required this.index,
    required this.currentIndex, // Add current index for comparison
    required this.preloadDistance, // Add preload distance
  ...
  bool get shouldPreload {
    // Preload if within preload distance of current index
